            ...
            <form @submit.prevent="updateEmployee">
                <div class="card-body">
                        <div class="form-group">
                            ...
                            <input v-model="form.firts_name" type="text" class="form-control" name="firts_name" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.last_name" type="text" class="form-control" name="last_name" value="">
                            <!-- <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span> -->
                        </div>
                        <div class="form-group">
                            ...
                            <input v-model="form.middle_name" type="text" class="form-control" name="middle_name" value="">
                            <!-- <span class="invalid-feedback" role="alert">
                                    <strong></strong>
                            </span> -->
                        </div>
                        <div class="form-group">
                            ...
                            <input v-model="form.address" type="text" class="form-control" name="address" value="">
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="form.city_id" class="custom-select" name="city">
                                <option
